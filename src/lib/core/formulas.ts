 ...
 */
export const evaluateFormula = (formula: string, record: any): any => {
 ...
 */
export const isImageResult = (val: any): val is ImageResult => {
    return val && typeof val === 'object' && val._type === 'image';
};
