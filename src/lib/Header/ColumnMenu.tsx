                ...
                <>
                  <button
                    ...
                    style={{
                      ...
                      padding: '4px 8px',
                      background:
                        currentSort === 'asc' ? (theme.tokens?.rowHoverColor ?? '#f0f0f0') : 'none',
                      border: 'none',
                      cursor: 'pointer',
                      borderRadius: '2px',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background:
                        currentSort === 'desc'
                          ? (theme.tokens?.rowHoverColor ?? '#f0f0f0')
                          : 'none',
                      border: 'none',
                      cursor: 'pointer',
                      borderRadius: '2px',
                  ...
                  <div
                    style={{
                      borderTop: `1px solid ${theme.tokens?.borderColor ?? '#eee'}`,
                      margin: '4px 0',
                    }}
                  />
                </>
            ...
            {column.filterable !== false && (
              ...
              >
                <input
                  ...
                  placeholder={`Search ${typeof column.title === 'string' ? column.title : column.key}...`}
                  value={searchValue}
